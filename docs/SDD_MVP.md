...
| `alexrag.llm.inferhub` | Inferhub OpenAI-compatible chat; **`INFERHUB_PROVIDER=cbcn` only**; model id `cbcn/glm-5.3-flash` (case-insensitive); `INFERHUB_API_KEY` env only (stub if unset) |
